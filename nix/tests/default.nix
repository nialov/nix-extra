  ...
  perSystem = { pkgs, ... }: {
    ...
    checks = let
      mkPandocRstCheck = pandoc: fails:
        ...
        in pkgs.runCommand "pandoc-rst-check" { } ''
          mkdir "$out"
    ...
    in {
      ...
      pandoc-rst-check-2411 =
        mkPandocRstCheck pkgs.release2411Packages.pandoc false;
      pandoc-rst-check-latest =
        mkPandocRstCheck pkgs.release2411Packages.pandoc true;
    };
